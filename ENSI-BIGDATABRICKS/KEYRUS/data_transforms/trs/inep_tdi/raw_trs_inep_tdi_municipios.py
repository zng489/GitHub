...
#  'schema': 'inep_tdi',
#  'table': 'municipios',
#  'prm_path': '/tmp/dev/prm/usr/inep_tdi/FIEC_inep_tdi_municipios_mapeamento_unificado_trusted.xlsx'
# }

# adf = {
#  "adf_factory_name": "cnibigdatafactory",
#  "adf_pipeline_name": "org_trs_atu",
#  "adf_pipeline_run_id": "",
#  "adf_trigger_id": "",
#  "adf_trigger_name": "",
...
df = df.filter((f.col('NO_REGIAO')!='nan') & (f.col('SG_UF')!='nan'))
