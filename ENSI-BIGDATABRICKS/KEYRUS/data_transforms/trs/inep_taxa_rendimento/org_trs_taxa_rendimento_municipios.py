...
#  'table': 'municipios',
#  'prm_path': '/tmp/dev/prm/usr/inep_taxa_rendimento/FIEC_INEP_taxa_rendimento_municipio_mapeamento_unificado_trusted.xlsx'
#}
...
#dls = {"folders":{"error":"/tmp/dev/err", "staging":"/tmp/dev/stg", "log":"/tmp/dev/log", "raw":"/tmp/dev/raw", "trs":"/tmp/dev/trs"}}
