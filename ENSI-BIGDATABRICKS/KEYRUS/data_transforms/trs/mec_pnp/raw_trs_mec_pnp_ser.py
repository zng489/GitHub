...
df = df.withColumn('CO_UNIDADE_DE_ENSINO_SISTEC', f.regexp_replace(f.col('CO_UNIDADE_DE_ENSINO_SISTEC'), '.0' ,''))
df = df.withColumn('VINCULO_NIVEL', f.regexp_replace(f.col('VINCULO_NIVEL'), '.0' ,''))
