...
# MAGIC 
# MAGIC <pre>
# MAGIC Processo	raw_trs_acao_educativa_sesi
# MAGIC Tabela/Arquivo Origem	"/raw/bdo/scae/curso
# MAGIC /raw/bdo/scae/produto_servico"
# MAGIC Tabela/Arquivo Destino	/trs/mtd/sesi/acao_educativa_sesi
...
# MAGIC Descrição Tabela/Arquivo Destino	Corresponde a relação de ações  voltadas à educação como eventos e cursos lvres oferecidos pelo SESI.
# MAGIC Tipo Atualização	U = update (insert/update)
# MAGIC Detalhe Atualização	Carga incremental por dh_ultima_atualizacao_oltp, que insere ou sobrescreve o registro caso a chave cd_acao_educacao_sesi seja encontrada.
# MAGIC Periodicidade/Horario Execução	Diária, após carga raw scae, que ocorre às 22:00
# MAGIC 
# MAGIC 
# MAGIC Dev: Patricia / Marcela
# MAGIC </pre>
...
"""
var_tables =  {"origins": ["/bdo/scae/curso", "/bdo/scae/produto_servico"], "destination": "/mtd/sesi/acao_educativa_sesi"}
...
var_adf = {'adf_factory_name': 'cnibigdatafactory', 
       'adf_pipeline_name': 'raw_trs_acao_educativa_sesi',
...
# MAGIC <pre>
# MAGIC /* 
# MAGIC Obter a maior data de referencia carregada #var_max_dh_ultima_atualizacao_oltp = SELECT MAX(dh_ultima_atualizacao_oltp) from acao_educativa_sesi
...
# MAGIC WHERE SUBSTRING(P.cod_centro_responsabilidade, 3, 5) NOT IN ('30301', '30303', '30304')  -- Não é EDUCACAO BASICA, EDUCACAO CONTINUADA, EDUCACAO PROFISSIONAL e EDUCACAO SUPERIOR
...
df_produto_servico = df_produto_servico.filter(~(substring(col("cod_centro_responsabilidade"), 3, 5).isin('30301','30303','30304'))).drop("cod_centro_responsabilidade")
...
.withColumn("cd_tipo_portfolio", when(col("cd_tipo_portfolio") != 1, lit(0)).otherwise(col("cd_tipo_portfolio")))
...
column_name_mapping = {"cod_curso": "cd_acao_educativa_sesi", 
                       "nom_curso": "nm_acao_educativa_sesi", 
                       "des_curso": "ds_acao_educativa_sesi", 
                       "cod_curso_dr": "ds_codificacao_acao_educativa_sesi_dr", 
...
trim_columns = ["nm_acao_educativa_sesi", "ds_acao_educativa_sesi"]
...
column_type_map = {"cd_acao_educativa_sesi":"int",
                   "nm_acao_educativa_sesi": "string",
                   "ds_acao_educativa_sesi": "string",
                   "ds_codificacao_acao_educativa_sesi_dr": "string",
...
# MAGIC %md
# MAGIC Keep only last refresh date by cd_acao_educativa_sesi

# COMMAND ----------

w = Window.partitionBy("cd_acao_educativa_sesi").orderBy(col("dh_ultima_atualizacao_oltp").desc())
