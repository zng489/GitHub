...
"""
var_file = {'namespace':'unigest','file_folder':'kpi_geral_calculado_mensal','extension':'CSV','column_delimiter':';','encoding':'UTF-8','null_value':''}

var_adf = {
  "adf_factory_name": "cnibigdatafactory",
  "adf_pipeline_name": "org_raw_kpi_geral_calculado_mensal",
