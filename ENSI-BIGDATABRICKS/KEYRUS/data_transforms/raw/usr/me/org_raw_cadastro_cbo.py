...
# MAGIC 
# MAGIC <b>Example:</b>
# MAGIC </br>source: /uld/uniepro/caged/cadastro_cbo
# MAGIC </br>sink: /ach/uniepro/caged/cadastro_cbo
...
df = df.withColumn('nr_ano', substring('nm_arq_in', 37, 4))
