...
from pyspark.sql.functions import udf, from_utc_timestamp, current_timestamp, input_file_name, lit, monotonically_increasing_id,substring
...
# var_file = {
#   'namespace': 'inep_saeb',
#   'file_folder': 'competencias_e_habilidades_ajuste_mt',
#   'extension': 'csv',
#   'column_delimiter': ';',
#   'encoding': 'UTF-8',
#   'null_value': ''
...
#   "adf_pipeline_name": "org_raw_competencias_habilidades_ajuste_mt",
