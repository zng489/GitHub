...
# var_file = {
#    'namespace': 'inep_saeb',
#    'file_folder': 'competencias_e_habilidades_mt',
#    'extension': 'csv',
#    'column_delimiter': ';',
#    'encoding': 'UTF-8',
#    'null_value': ''
...
#    "adf_pipeline_name": "org_raw_competencias_habilidades_mt",
...
df = spark.read.csv(path=var_adls_uri + var_source, sep=';', encoding='UTF-8', header=True,
                   nullValue='',quote='"',mode="FAILFAST",multiLine=True,ignoreLeadingWhiteSpace=True, ignoreTrailingWhiteSpace=True,
                   inferSchema=True)
