...
# var_file = {
#   'namespace': 'inep_saeb',
#   'file_folder': 'mascara_escolas_sesi',
#   'extension': 'csv',
#   'column_delimiter': ';',
#   'encoding': 'UTF-8',
#   'null_value': ''
...
#   "adf_pipeline_name": "org_raw_mascaras_escolas_sesi",
...
df = df.withColumnRenamed('CO_ENTIDADE','CD_ENTIDADE')
df = df.withColumnRenamed('CO_ENTIDADE_MASCARA','CD_ENTIDADE_MASCARA')
...
df = df.select('cd_entidade','cd_entidade_mascara')
...
df = df.withColumn('nr_ano', substring('nm_arq_in', 5, 4))
