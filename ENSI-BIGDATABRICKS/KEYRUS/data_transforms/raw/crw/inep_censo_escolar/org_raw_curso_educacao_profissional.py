...
# MAGIC %md
# MAGIC <pre>
# MAGIC Processo	org_raw_microdados_curso_educacao_profissional				
# MAGIC Tabela/Arquivo Origem	/lnd/crw/inep_censo_escolar__curso_educacao_profissional
# MAGIC Tabela/Arquivo Destino	/raw/crw/inep_censo_escolar/curso_educacao_profissional							
# MAGIC </pre>
...
df = df.withColumn('ANO', f.slice(f.split(f.input_file_name(), '/'), -2, 1).getItem(0).cast('Int'))
