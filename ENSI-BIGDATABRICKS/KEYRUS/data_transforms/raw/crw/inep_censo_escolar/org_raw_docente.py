...
# MAGIC %md
# MAGIC <pre>
# MAGIC Processo	org_raw_inep_censo_escolar_docente				
# MAGIC Tabela/Arquivo Origem	\lnd\crw\inep_censo_escolar__docente				
# MAGIC Tabela/Arquivo Destino	\raw\crw\inep_censo_escolar__docente				
# MAGIC Particionamento Tabela/Arquivo Destino	Ano do Censo (campo NU_ANO_CENSO)				
# MAGIC Descrição Tabela/Arquivo Destino Dados do Censo Escolar docente unificado a com base no layout de 2019				
# MAGIC Tipo Atualização	F = full				
...
try:
  ...
  table = {
   ...
   'prm_path': '/prm/usr/inep_censo_escolar_docente/KC2332_Censo_Escolar_Docentes_mapeamento_unificado_raw.xlsx'
 }

  adf = {
     "adf_factory_name": "cnibigdatafactory",
     "adf_pipeline_name": "org_raw_inep_censo_escolar_docente",
