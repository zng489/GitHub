...
path_lnd_gov = "{adl_path}{default_dir}/gov/usr_upload/bigdata/source/".format(adl_path=var_adls_uri,default_dir=default_dir)
...
source_dt.alias("governance").merge(
             ...
             "lower(governance.source_name) = lower(upsert.source_name)") \
