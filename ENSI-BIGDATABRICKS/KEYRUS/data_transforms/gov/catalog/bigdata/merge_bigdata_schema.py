...
path_lnd_gov = "{adl_path}{default_dir}/gov/usr_upload/bigdata/schema/".format(adl_path=var_adls_uri,default_dir=default_dir)
path_source = "{adl_path}{default_dir}/gov/tables/schema".format(adl_path=var_adls_uri,default_dir=default_dir)
...
source_dt.alias("governance").merge(
             ...
             "lower(governance.source_name) = lower(upsert.source_name) and lower(governance.schema_name) = lower(upsert.schema_name)")\
