...
# tables =  {
#   "path_origin": "ibge/cnae_subclasses",
#   "path_destination": "ibge/dim_cnae_subclasses",
#   "destination": "/ibge/dim_cnae_subclasses",
#   "databricks": {
#     "notebook": "/biz/ibge/dim_cnae_subclasses"
#   }
# }
...
df_columns = ['CD_SECAO', 'CD_DIVISAO', 'CD_GRUPO', 'CD_CLASSE', 'CD_SUBCLASSE', 'DS_DENOMINACAO']
